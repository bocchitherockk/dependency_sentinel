...
async def handle_topic_manifest_files_edited(key: str, value: dict, msg):
    ...
    if not manifest_files_edited_event.updated_manifest_files:
        return
    ...
    # TODO 2: get the body of the PR from the event ManifestFilesEditedEvent (which should be generated by the LLM)
    create_pull_request(
        repository_name=repository_name,
        repository_owner_name=repository_owner_name,
